            ...
            <div class="modal-dialog modal-xl d-flex justify-content-center align-items-center">
                <div class="modal-content" style="height:80vh;">
                    <div class="modal-header d-flex justify-content-center py-2">
                        <h5 class="mb-0 modal-title" id="exampleModalLabel">Create a new post</h5>
                    </div>
                    <div class="modal-body d-flex flex-column justify-content-center align-items-center">
                        ...
                        <h4 class="mt-3 fw-medium text-center">Drag photos and videos here</h4>
                        <button class="btn btn-primary btn-sm">Select from computer</button>
                    </div>
                </div>
            </div>
        </div>
